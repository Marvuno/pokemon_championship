...
def tutorial():
    ...
    print(f"\nTutorial #4: End Game\n\n"
          ...
          f"Net Kill Score (NKS): third deciding factor. It's equivalent to how many Pokemon you fainted in total - how many Pokemon your opponent fainted yours in total.\n"
